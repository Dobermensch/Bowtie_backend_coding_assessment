...
def run_migrations_online() -> None:
    ...
    # Sqlalchemy always tries to run queries in a transaction, and postgres does not allow users to create databases 
    # inside a transaction. To get around that, we end each open transaction automatically after execution. 
